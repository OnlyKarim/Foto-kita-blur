...
while True:
    ...
    # --- RESIZE MENJADI HD LEBAR (16:9) ---
    # Menggunakan 640x360 agar tetap lebar seperti aslinya tapi versi ringan
    ...
    # blur efek
    if peace_detected:
        # Menggunakan ukuran kernel (41, 41) agar efek blur pas dengan resolusi 360p
